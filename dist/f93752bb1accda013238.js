...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  width: 100vw;\n  height: 100vh;\n}\n\n.bg-light {\n  display: flex;\n  background-color: none;\n  justify-content: center;\n  align-items: center;\n}\n.bg-light.navbar > .container-fluid {\n  justify-content: center;\n}\n.bg-light.navbar > .container-fluid .navbar-brand {\n  display: flex;\n  flex-direction: column;\n  text-decoration: none;\n  justify-content: center;\n  align-items: center;\n}\n.bg-light.navbar > .container-fluid .navbar-brand h1 {\n  font-size: 36px;\n  color: #D04F4F;\n  font-weight: 700;\n  font-family: \"DM Sans\", sans-serif;\n  text-decoration: none;\n}\n.bg-light.navbar > .container-fluid .navbar-brand h1:link {\n  text-decoration: none;\n}\n.bg-light.navbar > .container-fluid .navbar-brand h1:visited {\n  text-decoration: none;\n}\n\n.form-inline {\n  display: flex;\n  height: 69px;\n  border-radius: 5px;\n}\n.form-inline .form-control {\n  font-family: \"Lato\", sans-serif;\n  font-weight: 400;\n  font-size: 18px;\n  background-color: #e7e7e7;\n  border-radius: 5px 0 0 5px;\n  border: none;\n}\n.form-inline .btn-outline-success {\n  border: none;\n  background-color: #e7e7e7;\n  border-radius: 0px 5px 5px 0px;\n}\n\n.custom-container {\n  margin: 0 150px;\n}\n\n.btn-group {\n  margin-right: 15px;\n}\n\n.dropdown-toggle {\n  display: flex;\n  justify-content: space-around;\n  align-items: center;\n  font-family: \"Lato\", sans-serif;\n  color: white;\n  font-weight: 700;\n  font-size: 18px;\n  width: 170px;\n  height: 69px;\n}\n.dropdown-toggle::after {\n  appearance: none;\n  border: none;\n  content: \"\";\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") center center no-repeat;\n  width: 16px;\n  height: 10px;\n}\n\n.recipes {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(380px, 1fr));\n  gap: 0.25rem;\n  margin-top: 1rem;\n}\n\n.recipe {\n  background-color: #E7E7E7;\n  margin: 15px;\n}\n.recipe .title {\n  font-family: Lato;\n  font-size: 18px;\n  font-weight: 400;\n  line-height: 22px;\n  letter-spacing: 0em;\n  text-align: left;\n}\n.recipe .timing {\n  font-family: Lato;\n  font-size: 18px;\n  font-weight: 700;\n  line-height: 22px;\n  letter-spacing: 0em;\n  text-align: left;\n}\n.recipe .ingredients {\n  font-family: Roboto;\n  font-size: 12px;\n  font-weight: 700;\n  line-height: 12px;\n  letter-spacing: 0em;\n  text-align: left;\n}\n.recipe .instructions {\n  font-family: Roboto;\n  width: 100%;\n  font-size: 12px;\n  font-weight: 400;\n  line-height: 12px;\n  letter-spacing: 0em;\n  text-align: left;\n}\n\n.hide {\n  display: none;\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAKA;EACI,YAAA;EACA,aAAA;AAJJ;;AAOI;EACI,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;AAJR;AAKQ;EACI,uBAAA;AAHZ;AAIY;EACI,aAAA;EACA,sBAAA;EACA,qBAAA;EACA,uBAAA;EACA,mBAAA;AAFhB;AAGgB;EACI,eAAA;EACA,cAAA;EACA,gBAAA;EAEA,kCAAA;EACA,qBAAA;AAFpB;AAGoB;EACI,qBAAA;AADxB;AAGoB;EACI,qBAAA;AADxB;;AASI;EACI,aAAA;EACA,YAAA;EACA,kBAAA;AANR;AAOQ;EACI,+BAAA;EACA,gBAAA;EACA,eAAA;EACA,yBAAA;EACA,0BAAA;EACA,YAAA;AALZ;AAOQ;EACI,YAAA;EACA,yBAAA;EACA,8BAAA;AALZ;;AASE;EACI,eAAA;AANN;;AAQE;EACI,kBAAA;AALN;;AAOI;EACI,aAAA;EACA,6BAAA;EACA,mBAAA;EACA,+BAAA;EACA,YAAA;EACA,gBAAA;EACA,eAAA;EACA,YAAA;EACA,YAAA;AAJR;AAKQ;EACI,gBAAA;EACA,YAAA;EACA,WAAA;EACA,2EAAA;EACA,WAAA;EACA,YAAA;AAHZ;;AAOI;EACG,aAAA;EACA,4DAAA;EACA,YAAA;EACA,gBAAA;AAJP;;AAMQ;EAEI,yBAAA;EACA,YAAA;AAJZ;AAKY;EACI,iBAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;AAHhB;AAMY;EACI,iBAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;AAJhB;AAOY;EACI,mBAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;AALhB;AAQY;EACI,mBAAA;EACA,WAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;AANhB;;AAYI;EACI,aAAA;AATR","sourcesContent":["\n\n\n\n\nbody {\n    width: 100vw;\n    height: 100vh;\n}\n\n    .bg-light {\n        display: flex;\n        background-color: none;\n        justify-content: center;\n        align-items: center;\n        &.navbar > .container-fluid {\n            justify-content: center;\n            & .navbar-brand {\n                display: flex;\n                flex-direction: column;\n                text-decoration: none;\n                justify-content: center;\n                align-items: center;\n                & h1 {\n                    font-size: 36px;\n                    color: #D04F4F;\n                    font-weight: 700\n                    ;\n                    font-family: 'DM Sans', sans-serif;\n                    text-decoration: none;\n                    &:link {\n                        text-decoration: none;\n                    }\n                    &:visited {\n                        text-decoration: none;\n                    }\n                }\n         \n            }\n        }\n    }\n   \n    .form-inline {\n        display: flex;\n        height: 69px;\n        border-radius: 5px;\n        & .form-control {\n            font-family: 'Lato', sans-serif;\n            font-weight: 400;\n            font-size: 18px;\n            background-color: #e7e7e7;\n            border-radius: 5px 0 0 5px;\n            border: none;\n        }\n        & .btn-outline-success {\n            border: none;\n            background-color: #e7e7e7;\n            border-radius: 0px 5px 5px 0px;\n        }\n    }\n\n  .custom-container {\n      margin: 0 150px;\n  }\n  .btn-group {\n      margin-right: 15px;\n  }\n    .dropdown-toggle {\n        display: flex;\n        justify-content: space-around;\n        align-items: center;\n        font-family: 'Lato', sans-serif;\n        color: white;\n        font-weight: 700;\n        font-size: 18px;\n        width: 170px;\n        height: 69px;\n        &::after {\n            appearance: none;\n            border: none;\n            content: \"\";\n            background: url(\"../assets/arrow_down.svg\") center center no-repeat;\n            width: 16px;\n            height: 10px;\n        }\n    }\n\n    .recipes {\n       display: grid;\n       grid-template-columns: repeat(auto-fill, minmax(380px, 1fr));\n       gap: .25rem;\n       margin-top: 1rem;\n    }\n        .recipe {\n            \n            background-color: #E7E7E7;\n            margin: 15px;\n            & .title {\n                font-family: Lato;\n                font-size: 18px;\n                font-weight: 400;\n                line-height: 22px;\n                letter-spacing: 0em;\n                text-align: left;\n\n            }\n            & .timing {\n                font-family: Lato;\n                font-size: 18px;\n                font-weight: 700;\n                line-height: 22px;\n                letter-spacing: 0em;\n                text-align: left;\n\n            }\n            & .ingredients {\n                font-family: Roboto;\n                font-size: 12px;\n                font-weight: 700;\n                line-height: 12px;\n                letter-spacing: 0em;\n                text-align: left;\n                \n            }\n            & .instructions {\n                font-family: Roboto;\n                width: 100%;\n                font-size: 12px;\n                font-weight: 400;\n                line-height: 12px;\n                letter-spacing: 0em;\n                text-align: left;\n\n            }\n        }\n    \n\n    .hide {\n        display: none;\n    }"],"sourceRoot":""}]);
// Exports
...
searchBar.addEventListener("input", function (e) {
  ...
  recipeList.forEach(function (list) {
    list.ingred.forEach(function (ing) {
      var isVisible = list.titre.toLowerCase().includes(value) || ing.ingredient.toLowerCase().includes(value);
...
/******/ })()
;
//# sourceMappingURL=f93752bb1accda013238.js.map